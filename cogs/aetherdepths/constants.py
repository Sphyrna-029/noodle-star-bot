...
AETHER_DROPS: Final[dict[int, list[_Drop]]] = {
    1: [
        ...
        ("hollow_stone", "mineral", 900, 0.70),
        ("primordial_dust", "mineral", 1500, 0.40),
        ("coal", "mineral", 50, 0.50),
        ("iron", "mineral", 100, 0.40),
    ...
    2: [
        ...
        ("forge_cinder", "mineral", 1300, 0.60),
        ("molten_slag", "mineral", 2200, 0.36),
        ("silver", "mineral", 150, 0.40),
        ("emerald", "mineral", 275, 0.24),
        ("stamina_elixir", "consumable", 25, 0.40),
        ("bank_insurance", "consumable", 0, 0.08),
        ("rune_fragment", "equipment", 0, 0.05),
    ],
    3: [
        ("health_potion", "consumable", 150, 0.80),
        ("golden_mushroom", "consumable", 75, 0.55),
        ("voidcell", "mineral", 2000, 0.50),
        ("crystal_marrow", "mineral", 3000, 0.30),
        ("platinum", "mineral", 225, 0.36),
        ("sapphire", "mineral", 400, 0.20),
        ("stamina_elixir", "consumable", 25, 0.45),
        ("bank_insurance", "consumable", 0, 0.10),
        ("fossilized_noodle", "equipment", 0, 0.03),
    ],
    4: [
        ("health_potion", "consumable", 150, 0.85),
        ("golden_mushroom", "consumable", 75, 0.70),
        ("warden_seal", "mineral", 2600, 0.45),
        ("temporal_fragment", "mineral", 4000, 0.25),
        ("mithril", "mineral", 350, 0.30),
        ("opal", "mineral", 625, 0.16),
        ("stamina_elixir", "consumable", 25, 0.50),
    ...
    5: [
        ("health_potion", "consumable", 150, 0.85),
        ("golden_mushroom", "consumable", 75, 0.80),
        ("core_ember", "mineral", 3500, 0.40),
        ("world_essence", "mineral", 5500, 0.20),
        ("dragonstone", "mineral", 525, 0.25),
        ("void_crystal", "mineral", 900, 0.16),
        ("stamina_elixir", "consumable", 25, 0.55),
        ("bank_insurance", "consumable", 0, 0.15),
        ("fossilized_noodle", "equipment", 0, 0.05),
...
AETHER_BOSS_BONUS_DROPS: Final[list[_Drop]] = [
    ("health_potion", "consumable", 50, 0.90),
    ("golden_mushroom", "consumable", 25, 0.85),
    ("star_magnet", "equipment", 0, 0.12),
    ("lucky_charm", "equipment", 0, 0.10),
    ("heart_of_leviathan", "equipment", 0, 0.06),
    ("stamina_elixir", "consumable", 25, 0.80),
    ("bank_insurance", "consumable", 0, 0.25),
    ("rune_fragment", "equipment", 0, 0.10),
    ("fossilized_noodle", "equipment", 0, 0.08),
...
KEY_MATERIAL_DROPS: Final[dict[int, list[_Drop]]] = {
    1: [("aether_shard", "mineral", 2500, 0.16)],
    2: [("infernal_core", "mineral", 3750, 0.12)],
    3: [("prismatic_lens", "mineral", 5000, 0.10)],
    4: [("chrono_crystal", "mineral", 6500, 0.08)],
    5: [("heart_of_the_world", "mineral", 10000, 0.06)],
}
