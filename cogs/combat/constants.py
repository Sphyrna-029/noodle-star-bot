...
DUNGEON_DROPS: Final[dict[int, list[_Drop]]] = {
    1: [
        # Consumables
        ("raw_potato", "consumable", 10, 0.70),
        ("raw_potato", "consumable", 10, 0.40),
        ("health_potion", "consumable", 150, 0.30),
        ("stamina_elixir", "consumable", 25, 0.35),
        # Minerals — L1 resources at higher rates
        ("coal", "mineral", 50, 0.60),
        ("iron", "mineral", 100, 0.50),
        ("gold", "mineral", 200, 0.30),
        ("diamond", "mineral", 500, 0.16),
        # Rare effect item
        ("rune_fragment", "equipment", 0, 0.03),
    ],
    2: [
        ("health_potion", "consumable", 150, 0.40),
        ("golden_mushroom", "consumable", 75, 0.30),
        ("stamina_elixir", "consumable", 25, 0.30),
        ("bank_insurance", "consumable", 0, 0.07),
        # Minerals — L2 resources
        ("copper", "mineral", 75, 0.50),
        ("silver", "mineral", 150, 0.50),
        ("emerald", "mineral", 300, 0.30),
        ("ruby", "mineral", 750, 0.16),
        # Fish
        ("salmon", "fish", 800, 0.24),
        ("tuna", "fish", 1300, 0.16),
        # Rare effect item
    ...
    3: [
        ...
        ("platinum", "mineral", 250, 0.44),
        ("sapphire", "mineral", 450, 0.30),
        ("amethyst", "mineral", 1125, 0.16),
        # Rare fish
        ("reef_shark", "fish", 1475, 0.20),
        ("giant_clam", "fish", 2750, 0.12),
        ("golden_seahorse", "fish", 18325, 0.06),
        # Stamina material
        ("seaweed", "fish", 0, 0.30),
        # Effect items
        ("bank_insurance", "consumable", 0, 0.08),
        ("rune_fragment", "equipment", 0, 0.04),
    ],
    4: [
        ("health_potion", "consumable", 150, 0.60),
        ("golden_mushroom", "consumable", 75, 0.50),
        ("stamina_elixir", "consumable", 25, 0.35),
        # Minerals — L4 resources
        ("mithril", "mineral", 400, 0.40),
        ("opal", "mineral", 700, 0.24),
        ("star_fragment", "mineral", 1750, 0.12),
        # Rare fish
        ("hammerhead_shark", "fish", 2075, 0.20),
        ("pirates_hoard", "fish", 11275, 0.10),
        ("phantom_captain", "fish", 26050, 0.06),
        # Stamina material
        ("bioluminescent_jelly", "fish", 0, 0.24),
        # Effect items
        ("bank_insurance", "consumable", 0, 0.10),
        ("fossilized_noodle", "equipment", 0, 0.04),
        ("star_magnet", "equipment", 0, 0.03),
    ],
    5: [
        ("health_potion", "consumable", 150, 0.70),
        ("golden_mushroom", "consumable", 75, 0.55),
        ("stamina_elixir", "consumable", 25, 0.40),
        # Minerals — L5 resources
        ("dragonstone", "mineral", 600, 0.36),
        ("void_crystal", "mineral", 1000, 0.20),
        ("noodle_gem", "mineral", 2500, 0.10),
        # Legendary fish
        ("megalodon_tooth", "fish", 6500, 0.16),
        ("trench_treasure", "fish", 18575, 0.10),
        ("leviathan_scale", "fish", 46400, 0.06),
        ("poseidons_eye", "fish", 92825, 0.04),
        # Space ores
        ("dark_matter", "ore", 3500, 0.12),
        ("plutonium_core", "ore", 5750, 0.08),
        ("void_coral", "fish", 0, 0.24),
        # Effect items
        ("bank_insurance", "consumable", 0, 0.12),
        ("fossilized_noodle", "equipment", 0, 0.04),
...
BOSS_BONUS_DROPS: Final[list[_Drop]] = [
    ("health_potion", "consumable", 50, 0.85),
    ("golden_mushroom", "consumable", 25, 0.75),
    ("stamina_elixir", "consumable", 25, 0.70),
    ("bank_insurance", "consumable", 0, 0.20),
    # Drop-only combat gear (very rare)
    ("golden_axe", "equipment", 0, 0.06),
    ("mithril_shield", "equipment", 0, 0.06),
    # Rare effect items
    ("star_magnet", "equipment", 0, 0.10),
    ("lucky_charm", "equipment", 0, 0.08),
    ("rune_fragment", "equipment", 0, 0.08),
    ("fossilized_noodle", "equipment", 0, 0.06),
    ("heart_of_leviathan", "equipment", 0, 0.02),
]
...
MINING_AMBUSH_DROPS: Final[dict[int, list[_Drop]]] = {
    1: [
        ("stone", "mineral", 15, 0.60),
        ("coal", "mineral", 30, 0.50),
        ("iron", "mineral", 60, 0.20),
        ("raw_potato", "consumable", 6, 0.30),
        ("stamina_elixir", "consumable", 25, 0.30),
        ("health_potion", "consumable", 150, 0.10),
    ],
    2: [
        ("copper", "mineral", 45, 0.50),
        ("silver", "mineral", 90, 0.30),
        ("emerald", "mineral", 180, 0.10),
        ("raw_potato", "consumable", 6, 0.30),
        ("health_potion", "consumable", 150, 0.16),
        ("stamina_elixir", "consumable", 25, 0.30),
        ("golden_mushroom", "consumable", 75, 0.12),
    ],
    3: [
        ("tin", "mineral", 75, 0.40),
        ("platinum", "mineral", 150, 0.30),
        ("sapphire", "mineral", 270, 0.12),
        ("health_potion", "consumable", 150, 0.24),
        ("golden_mushroom", "consumable", 75, 0.16),
        ("stamina_elixir", "consumable", 25, 0.35),
        ("rune_fragment", "equipment", 0, 0.04),
    ],
    4: [
        ("titanium", "mineral", 120, 0.36),
        ("mithril", "mineral", 240, 0.24),
        ("opal", "mineral", 420, 0.10),
        ("star_fragment", "mineral", 1050, 0.04),
        ("health_potion", "consumable", 150, 0.30),
        ("stamina_elixir", "consumable", 25, 0.35),
    ...
    5: [
        ("adamantium", "mineral", 180, 0.30),
        ("dragonstone", "mineral", 360, 0.20),
        ("void_crystal", "mineral", 600, 0.08),
        ("noodle_gem", "mineral", 1500, 0.02),
        ("health_potion", "consumable", 150, 0.36),
        ("golden_mushroom", "consumable", 75, 0.24),
        ("stamina_elixir", "consumable", 25, 0.40),
        ("bank_insurance", "consumable", 0, 0.08),
...
FISHING_AMBUSH_DROPS: Final[dict[int, list[_Drop]]] = {
    2: [
        ("trout", "fish", 60, 0.50),
        ("catfish", "fish", 75, 0.40),
        ("bass", "fish", 90, 0.24),
        ("seaweed", "fish", 50, 0.30),
        ("health_potion", "consumable", 150, 0.16),
        ("stamina_elixir", "consumable", 25, 0.30),
        ("golden_mushroom", "consumable", 75, 0.15),
    ],
    3: [
        ("clownfish", "fish", 50, 0.40),
        ("parrotfish", "fish", 90, 0.30),
        ("moray_eel", "fish", 110, 0.20),
        ("reef_shark", "fish", 350, 0.10),
        ("sea_sponge", "fish", 50, 0.30),
        ("golden_seahorse", "fish", 1800, 0.06),
        ("health_potion", "consumable", 150, 0.15),
        ("stamina_elixir", "consumable", 25, 0.30),
        ("bucktail_jig", "equipment", 0, 0.03),
    ],
    4: [
        ("barracuda", "fish", 250, 0.36),
        ("swordfish", "fish", 350, 0.24),
        ("hammerhead_shark", "fish", 500, 0.16),
        ("barnacle_cluster", "fish", 120, 0.30),
        ("health_potion", "consumable", 150, 0.24),
        ("phantom_captain", "fish", 2600, 0.06),
        ("stamina_elixir", "consumable", 25, 0.35),
        ("golden_mushroom", "consumable", 75, 0.18),
        ("bank_insurance", "consumable", 0, 0.08),
    ],
    5: [
        ("vampire_squid", "fish", 375, 0.30),
        ("dragonfish", "fish", 840, 0.20),
        ("megalodon_tooth", "fish", 1625, 0.12),
        ("void_coral", "fish", 200, 0.24),
        ("bioluminescent_jelly", "fish", 240, 0.20),
        ("leviathan_scale", "fish", 4640, 0.04),
        ("health_potion", "consumable", 150, 0.30),
        ("stamina_elixir", "consumable", 25, 0.40),
...
SPACE_AMBUSH_DROPS: Final[dict[int, list[_Drop]]] = {
    1: [
        ("moon_dust", "ore", 90, 0.60),
        ("helium_3", "ore", 180, 0.40),
        ("lunar_quartz", "ore", 360, 0.20),
        ("raw_potato", "consumable", 6, 0.30),
        ("stamina_elixir", "consumable", 25, 0.30),
        ("health_potion", "consumable", 150, 0.10),
    ],
    2: [
        ("red_sand", "ore", 130, 0.50),
        ("martian_iron", "ore", 260, 0.36),
        ("phobos_shard", "ore", 520, 0.16),
        ("health_potion", "consumable", 150, 0.20),
        ("stamina_elixir", "consumable", 25, 0.30),
        ("golden_mushroom", "consumable", 75, 0.12),
    ],
    3: [
        ("ring_fragment", "ore", 180, 0.44),
        ("titan_ore", "ore", 360, 0.30),
        ("ammonia_ice", "ore", 720, 0.16),
        ("saturn_sapphire", "ore", 1200, 0.08),
        ("health_potion", "consumable", 150, 0.24),
        ("stamina_elixir", "consumable", 25, 0.35),
        ("golden_mushroom", "consumable", 75, 0.15),
        ("rune_fragment", "equipment", 0, 0.04),
    ...
    4: [
        ("ice_rock", "ore", 250, 0.40),
        ("methane_crystal", "ore", 500, 0.28),
        ("miranda_stone", "ore", 1000, 0.16),
        ("uranian_diamond", "ore", 1660, 0.06),
        ("health_potion", "consumable", 150, 0.30),
        ("golden_mushroom", "consumable", 75, 0.20),
        ("stamina_elixir", "consumable", 25, 0.40),
        ("bank_insurance", "consumable", 0, 0.08),
    ...
    5: [
        ("frozen_nitrogen", "ore", 350, 0.36),
        ("charon_basalt", "ore", 700, 0.24),
        ("dark_matter", "ore", 1400, 0.12),
        ("plutonium_core", "ore", 2300, 0.06),
        ("eternity_gem", "ore", 5750, 0.02),
        ("health_potion", "consumable", 150, 0.36),
        ("golden_mushroom", "consumable", 75, 0.24),
