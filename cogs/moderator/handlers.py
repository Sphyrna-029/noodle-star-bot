...
_GIVE_ITEMS: dict[str, list[tuple[str, str, str, str, int]]] = {
    "Consumables": [
        ...
        ("giant_catfish", "Giant Catfish (75HP+30stam)", "🐟", "inventory", 0),
        ("snapping_turtle", "Snapping Turtle (65HP+20stam)", "🐢", "inventory", 0),
        ("melon", "Melon (80HP+40stam)", "🍉", "inventory", 0),
        ("octopus", "Octopus (62HP+15stam)", "🐙", "inventory", 0),
        ("lobster", "Lobster (52HP)", "🦞", "inventory", 0),
    ...
    "Crops": [
        ("wheat", "Wheat", "🌾", "inventory", 0),
        ("carrot", "Carrot", "🥕", "inventory", 0),
        ("corn", "Corn", "🌽", "inventory", 0),
        ("tomato", "Tomato", "🍅", "inventory", 0),
        ("melon", "Melon", "🍉", "inventory", 0),
    ],
    "Minerals (High)": [
        ("diamond", "Diamond", "💎", "inventory", 0),
        ("ruby", "Ruby", "❤️", "inventory", 0),
        ("amethyst", "Amethyst", "💜", "inventory", 0),
        ("star_fragment", "Star Fragment", "🌟", "inventory", 0),
        ("darkite", "Darkite", "🌑", "inventory", 0),
        ("adamantium", "Adamantium", "⛓️", "inventory", 0),
        ("dragonstone", "Dragonstone", "🐉", "inventory", 0),
        ("void_crystal", "Void Crystal", "🔮", "inventory", 0),
        ("noodle_gem", "Noodle Gem", "🍜", "inventory", 0),
    ],
    "Space Ores": [
        ("cosmic_pearl", "Cosmic Pearl", "🦪", "inventory", 0),
        ("olympus_ruby", "Olympus Ruby", "🌋", "inventory", 0),
        ("stardust_crystal", "Stardust Crystal", "✴️", "inventory", 0),
        ("saturn_sapphire", "Saturn Sapphire", "💍", "inventory", 0),
        ("nova_core", "Nova Core", "💥", "inventory", 0),
        ("uranian_diamond", "Uranian Diamond", "💠", "inventory", 0),
        ("nebula_shard", "Nebula Shard", "🌌", "inventory", 0),
        ("plutonium_core", "Plutonium Core", "☢️", "inventory", 0),
        ("dark_matter", "Dark Matter", "⚛️", "inventory", 0),
        ("eternity_gem", "Eternity Gem", "👑", "inventory", 0),
    ],
    "Aether Materials": [
        ("hollow_stone", "Hollow Stone", "🪨", "inventory", 0),
        ("primordial_dust", "Primordial Dust", "✨", "inventory", 0),
        ("aether_shard", "Aether Shard", "💠", "inventory", 0),
        ("forge_cinder", "Forge Cinder", "🔥", "inventory", 0),
        ("molten_slag", "Molten Slag", "🟠", "inventory", 0),
        ("infernal_core", "Infernal Core", "🔴", "inventory", 0),
        ("voidcell", "Voidcell", "🟣", "inventory", 0),
        ("crystal_marrow", "Crystal Marrow", "💎", "inventory", 0),
        ("prismatic_lens", "Prismatic Lens", "🌈", "inventory", 0),
        ("warden_seal", "Warden Seal", "🏛️", "inventory", 0),
        ("temporal_fragment", "Temporal Fragment", "⏳", "inventory", 0),
        ("chrono_crystal", "Chrono Crystal", "⌛", "inventory", 0),
        ("core_ember", "Core Ember", "🌋", "inventory", 0),
        ("world_essence", "World Essence", "🌍", "inventory", 0),
        ("heart_of_the_world", "Heart of the World", "❤️‍🔥", "inventory", 0),
    ],
    "Permanent Items": [
